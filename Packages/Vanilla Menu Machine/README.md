# Vanilla Media Library

Vanilla Media Library is part of the Vanilla For Unity SDK.

Vanilla Media Library is a toolkit for generating Netflix-style content menus.
