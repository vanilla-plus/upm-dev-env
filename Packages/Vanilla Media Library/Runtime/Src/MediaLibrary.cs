...
namespace Vanilla.MediaLibrary
{
	...
	public static class MediaLibrary
	{
		...
		public static async UniTask FetchViaFactory<C, I>(CatalogueFactory<C, I> factory)
			where C : class, ICatalogue<I>
			where I : class, ICatalogueItem => await FetchViaJson<C, I>(catalogue: factory.catalogue,
			                                                            json: factory.output);
