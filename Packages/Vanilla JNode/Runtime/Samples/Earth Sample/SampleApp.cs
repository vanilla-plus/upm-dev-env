...
namespace Vanilla.JNode.Samples
{
	                         ...
	                         IEquatable<Continent>
	{
		...
		{
			Debug.Log($"[{Name}] Country discovered [{item.Name}]");
	...
	public class SampleApp : MonoBehaviour
	{
		...
		public async void ParseJustEarth() => await earth.FromRemoteConfig(rootKey: "earth",
		                                                                   fallback: string.Empty);


		[ContextMenu("Parse Continents")]
		public async void ParseJustContinents() => await earth.FromRemoteConfig(rootKey: "earthContinents",
		                                                                        fallback: string.Empty);
