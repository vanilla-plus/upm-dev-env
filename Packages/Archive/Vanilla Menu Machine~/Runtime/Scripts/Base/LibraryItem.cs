...
//			public void Populate(JToken data) => text.text = (string) data[key];
		...
		[NonSerialized] private bool _leased;
		public bool Leased
		{
			get => _leased;
			set => _leased = value;
...
//		[NonSerialized] private IPool<P,PI> _pool;
//		public IPool<P,PI> Pool
//		{
//			get => _stockAsyncPool;
//			set => _stockAsyncPool = value;
//		}

//		public abstract UniTask HandleGet();
//
//
//		public abstract UniTask HandleRetire();
//
//		public async   UniTask Retire() => await _stockAsyncPool.Retire(item: this);
