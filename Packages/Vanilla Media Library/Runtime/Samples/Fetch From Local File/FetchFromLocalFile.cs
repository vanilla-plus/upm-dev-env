...
namespace Vanilla.MediaLibrary.Samples
{
    ...
    public class FetchFromLocalFile : MonoBehaviour
    {
        ...
        public static async UniTask Init() => await MediaLibrary.FetchViaLocalFile<SampleCatalogue, SampleCatalogueItem>(catalogue: Catalogue,
                                                                                                                         path: Application.dataPath + "/Samples/Vanilla Media Library/1.0.0/Sample Catalogue/manifest.json");


        void Awake() => MediaLibrary.OnCatalogueFetchSuccess += () => catalogue = Catalogue;
